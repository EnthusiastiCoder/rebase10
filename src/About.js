...
const about = {
  ...
  return (
    <div className='w-full bg-white relative overflow-x-hidden flex items-center justify-center px-[15%] flex-wrap gap-[2vh]'>
        <div className='flex flex-col relative w-full sm:w-[60%]'>
            <h1 className='text-white text-[calc(2.5vw+20px)] font-heading font-bold px-[2.5%] drop-shadow-heading pb-[calc(8px+0.5%)]'>{about.title}</h1>
